...
- An Internet Gateway attached to the VPC, and route table configuration to allow the instances to connect to the internet
- A Security Group to allow HTTP and SSH traffic into the EC2 instance
- An S3 bucket to store static images served by the EC2 instances
...
Abhishek Veeramalla and CloudChamp on YT: https://www.youtube.com/watch?v=Koabqyopqns&list=PLdpzxOOAlwvI0O4PeKVV1-yJoX2AqIWuf&index=10
